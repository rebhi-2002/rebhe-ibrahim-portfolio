...
const FullStackDevelopmentPage = () => {
  ...
  const relatedProjects = projects.filter(project => 
    project.tech.some(tech => 
      ['React', 'Next.js', 'Node.js', 'Express', 'MongoDB', 'Firebase'].includes(tech)
    )
  );
  ...
  const process = [
    {
      ...
      duration: "1-2 weeks",
      description: "Understanding your business requirements, target audience, and technical specifications. Creating detailed project roadmap and architecture planning.",
      deliverables: ["Project specification document", "Technical architecture plan", "Timeline and milestones"]
    },
    {
      phase: "Design & Prototyping",
      duration: "1-2 weeks", 
      description: "Creating wireframes, user interface designs, and interactive prototypes to visualize the final product.",
      deliverables: ["UI/UX designs", "Interactive prototypes", "Design system"]
    },
    {
      phase: "Backend Development",
      duration: "2-4 weeks",
      description: "Building the server-side logic, database structure, APIs, and authentication systems.",
      deliverables: ["Database schema", "REST APIs", "Authentication system", "Admin panel"]
    },
    {
      phase: "Frontend Development", 
      duration: "3-5 weeks",
      description: "Developing the user interface, integrating with backend APIs, and implementing interactive features.",
      deliverables: ["Responsive web application", "User dashboard", "Interactive features"]
    },
    {
      phase: "Testing & Optimization",
      duration: "1-2 weeks",
      description: "Comprehensive testing, performance optimization, and security audits to ensure production readiness.",
      deliverables: ["Test reports", "Performance optimization", "Security audit"]
    },
    {
      phase: "Deployment & Launch",
      duration: "1 week",
      description: "Production deployment, domain setup, monitoring configuration, and post-launch support.",
  ...
  const faqs = [
    {
      ...
      answer: "I primarily use React/Next.js for the frontend, Node.js/Express for the backend, and databases like MongoDB, Firebase, or Supabase. The exact tech stack is chosen based on your specific requirements and scalability needs."
    },
    {
      question: "How do you ensure the application is secure?",
      answer: "Security is built into every layer - from secure authentication systems, data validation, encrypted communications (HTTPS), secure database configurations, and regular security audits. I follow industry best practices and OWASP guidelines."
    },
    {
      question: "Can you integrate with existing systems or APIs?",
      answer: "Absolutely! I have extensive experience integrating with third-party APIs, payment gateways (Stripe, PayPal), CRM systems, and existing databases. I can also build custom APIs to connect different systems."
    },
    {
      question: "What's included in post-launch support?",
      answer: "Post-launch support includes bug fixes, security updates, performance monitoring, backup management, and technical support. I offer different maintenance packages based on your needs."
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-8">
                End-to-end web application development using cutting-edge technologies. 
                From database design to user interface, I build complete digital solutions 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                I use modern, proven technologies to build robust and scalable applications
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-xl text-gray-400 mb-8">
                  Comprehensive full-stack development services that cover every aspect 
                  of your web application, from initial concept to ongoing maintenance.
                </p>
              ...
              >
                <h3 className="text-2xl font-bold mb-6">Why Choose Full-Stack?</h3>
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-400">
                      Single developer handling both frontend and backend ensures 
                      seamless integration and consistent code quality throughout your project.
                    </p>
                  </div>
                  <div>
                    <h4 className="text-lg font-semibold mb-2 text-blue-400">

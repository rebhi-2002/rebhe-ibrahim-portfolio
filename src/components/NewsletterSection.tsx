...
// ================================================================
// 2. مكون داخلي للنموذج - يعالج الإدخال والرسائل
// ================================================================
const NewsletterFormContent: React.FC<FormContentProps> = ({
  status,
  message,
  onValidated,
}) => {
...
// ================================================================
// 3. المكون الرئيسي الذي ستستخدمه في صفحتك
// ================================================================
